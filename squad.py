...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"u8451873ac51eb96a4d53f1e5b5806c46","uf7a2ac1cf85996d5ffd504f9f966f1ed"]
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["masuk","Masuk","All join","Ayo masuk"]:
              if msg.from_ in admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye all","pulang","Pulang","Bro @bye"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,"pikachu")
                ki.sendText(msg.to,"Gembul")
                kk.sendText(msg.to,"Doraemon")
                kc.sendText(msg.to,"Mas Vroh")
                ks.sendText(msg.to,"Qoobee")
                ka.sendText(msg.to,"Kanjeng")
                kb.sendText(msg.to,"Aboy")
                ko.sendText(msg.to,"Rizalemo")
                ke.sendText(msg.to,"Kakek")
                ku.sendText(msg.to,"Anu")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Speedbot","speed","Speed","speedbot"]:
                start = time.time()
